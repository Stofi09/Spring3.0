...
public class Movement {
  private static Position newPosition;
    public static void moveUp(Character character, List<PositionedImage> wall,int mapLevel){
        newPosition = new Position(character.getPosition().getX(),character.getPosition().getY() - MapBuilder.pixelSize);
        if(CheckSpace.checkNextStep(character.getPosition().getY() - MapBuilder.pixelSize,newPosition, wall,mapLevel)){
    ...
    public static void moveDown(Character character, List<PositionedImage> wall,int mapLevel){
        newPosition = new Position(character.getPosition().getX(),character.getPosition().getY() + MapBuilder.pixelSize);
        if(CheckSpace.checkNextStep(character.getPosition().getY() + MapBuilder.pixelSize,newPosition, wall,mapLevel)){
            if(character instanceof Hero)  character.setUrl(Orient.UP.getUrl()) ;
        }else {
    ...
    public static void moveLeft(Character character, List<PositionedImage> wall,int mapLevel){
        newPosition = new Position(character.getPosition().getX() -  MapBuilder.pixelSize,character.getPosition().getY());
        if(CheckSpace.checkNextStep(character.getPosition().getX() - MapBuilder.pixelSize,newPosition, wall,mapLevel)){
    ...
    public static void moveRight(Character character, List<PositionedImage> wall,int mapLevel){
        newPosition = new Position(character.getPosition().getX() +  MapBuilder.pixelSize,character.getPosition().getY());
        if(CheckSpace.checkNextStep(character.getPosition().getX() + MapBuilder.pixelSize,newPosition, wall,mapLevel)){
            if(character instanceof Hero)  character.setUrl(Orient.LEFT.getUrl());
        }else {
